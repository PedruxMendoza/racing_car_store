     ...
     <div id="JiSlider" class="jislider">
      <ul>
        ...
        <div class="about py-5">
          <div class="container py-lg-5 py-lg-3">
            <h3 class="title text-capitalize text-dark text-center pb-3 mb-sm-5 mb-4">Vehiculos
              <span></span>
            </h3>
            <center>
            ...
            <div class="table-responsive-xl">
              <table class="table table-striped table-dark table-curved" id="veh">
                <thead>
                  <tr>
                    <td>Matricula</td>
                    <td>Color</td>
                ...
                <tbody>
                  <?php foreach ($this->obj_model->get_vehiculo() as $valor) { ?>
                    <tr>
                      <td><?php echo $valor[0] ?></td>
                      <td style="background: <?php echo $valor[1] ?>;"></td>
                      ...
                      <td>
                        <div class="btn-group" role="group">
                          ...
                          <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            ...
                            <a onclick="return confirm('Esta seguro de eliminar el modelo <?php echo $valor[4] ?> ?');" class="dropdown-item" href="?action=<?php echo $e ?>&id=<?php echo $id ?>">Eliminar</a>
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header" style="background-color: black">
                <h5 class="modal-title" id="exampleModalLabel" style="font-family: 'Poppins', sans-serif; color: #2471A3;">Nuevo Vehiculo</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: white">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <img src="../props/images/bannermodal2.png">
                ...
                <form action="" method="POST">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control" name="matricula" required="" placeholder="Ingrese la matricula...">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="color" class="form-control" name="color" required="" placeholder="Ingrese un Color...">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="number" maxlength="4" class="form-control" name="anio" required="" placeholder="Año que desea...">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="number" class="form-control" name="precio" required="" placeholder="Precio Unitario...">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group mb-2">
                      ...
                      <select class="form-control" name="modelo" required="">
                        ...
                        <?php foreach($this->obj_model->get_modelo() as $carrera){ ?>
                      ...
                      <div class="input-group mb-2">
                        ...
                        <select class="form-control" name="dispo" required="">
                          ...
                          <?php foreach($this->obj_model->get_disponibilidad() as $disponibilidad){ ?>
                            <option value="<?php echo $disponibilidad[0]?>"> <?php echo $disponibilidad[1] ?></option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="input-group mb-2">
                      ...
                      <select class="form-control" name="concesionaria" required="">
                        ...
                        <?php foreach($this->obj_model->get_concesionaria() as $concesionaria){ ?>
                          <option value="<?php echo $concesionaria[0]?>"> <?php echo $concesionaria[1] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
