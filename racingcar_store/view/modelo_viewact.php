      ...
      <ul>
        ...
        <div class="about py-5">
          <div class="container py-xl-5 py-lg-3">
            <h3 class="title text-capitalize text-dark text-center pb-3 mb-sm-5 mb-4">Modelos - Actualizar
              <span></span>
            </h3>
            <?php foreach($this->obj_m->get_modelo_act(base64_decode($_REQUEST["id"])) as $valor){ ?>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control" id="inlineFormInputGroup" name="modelo" required placeholder="Ingrese Nombre del Modelo.." value="<?php echo $valor[1] ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <br>
                    <center>
                      <img class="img-thumbnail"src="../props/catalogo/<?php echo $valor[2] ?>">
                    </center>
                  </div>
                  <div class="form-group">
                    <div class="input-group mb-2">
                      ...
                      <select class="form-control" name="marca" required>
                        ...
                        <?php foreach ($this->obj_m->get_marcas() as $marcas) { ?>
                          <option value="<?php echo $marcas[0] ?>"<?php if ($marcas[0]==$valor[3]){ echo "selected";} ?>><?php echo $marcas[1] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
