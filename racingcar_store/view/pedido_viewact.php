      ...
      <ul>
        ...
        <div class="about py-5">
          <div class="container py-xl-5 py-lg-3">
            <h3 class="title text-capitalize text-dark text-center pb-3 mb-sm-5 mb-4">Pedidos - Actualizar
              <span></span>
            </h3>
            <?php foreach($this->obj_pedido->get_datos_pedidos(base64_decode($_REQUEST["id"])) as $valor){ ?>
                ...
                <form action="" method="POST" autocomplete="off">
                  ...
                  <div class="form-group">
                    <div class="input-group mb-2">
                      ...
                      <select class="form-control" name="modelo" required>
                        ...
                        <?php foreach ($this->obj_pedido->get_modelo() as $modelo) { ?>
                          <option value="<?php echo $modelo[0] ?>"<?php if ($modelo[0]==$valor[1]){ echo "selected";} ?>><?php echo $modelo[1]?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group mb-2">
                      ...
                      <input type="number" class="form-control" id="inlineFormInputGroup"  name="cantidad" required placeholder="Cantidad a pedir..." value="<?php echo $valor[2]?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group mb-2">
                      ...
                      <select class="form-control" id="inlineFormCustomSelect" name="proveedor" required>
                        ...
                        <?php foreach ($this->obj_pedido->get_proveedor() as $proveedor) { ?>
                          <option value="<?php echo $proveedor[0] ?>"<?php if ($proveedor[0]==$valor[8]){ echo "selected";} ?>><?php echo $proveedor[1]?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="input-group mb-2">
                      ...
                      <select class="form-control" id="inlineFormCustomSelect" name="concesionario" required>
                        ...
                        <?php foreach ($this->obj_pedido->get_concesionario() as $concesionario) { ?>
                          <option value="<?php echo $concesionario[0] ?>"<?php if ($concesionario[0]==$valor[3]){ echo "selected";} ?>><?php echo $concesionario[1]?></option>
                          <?php } ?>>
                        </select>
                      </div>
                    </div>
