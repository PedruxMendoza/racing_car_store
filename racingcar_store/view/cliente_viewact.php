      ...
      <ul>
        ...
        <div class="about py-5">
          <div class="container py-xl-5 py-lg-3">
            <h3 class="title text-capitalize text-dark text-center pb-3 mb-sm-5 mb-4">Clientes - Actualizar
              <span></span>
            </h3>
            <?php foreach ($this->obj_cliente->get_datos_clientes(base64_decode($_REQUEST["id"])) as $valor) { ?>
                ...
                <form action="" method="POST" autocomplete="off">
                  ...
                  <div class="form-row">
                    <div class="col">
                      ...
                      <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" id="inlineFormInputGroup" name="nombre" required placeholder="Digite su nombre..." value="<?php echo $valor[1] ?>">
                      </div>
                    </div>
                    <div class="col">
                      <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" id="inlineFormInputGroup" name="apellido" required placeholder="Digite su apellido..." value="<?php echo $valor[2] ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group mb-2">
                      <label class="sr-only" for="inlineFormInputGroup">Usuario</label>
                        ...
                        <input type="text" class="form-control" id="inlineFormInputGroup" name="usuario" required placeholder="Digite su usuario..." value="<?php echo $valor[3] ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group mb-2">
                      ...
                      <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="rol" required>
                        ...
                        <?php foreach ($this->obj_cliente->get_rol() as $rol) { ?>
                          <option value="<?php echo $rol[0] ?>"<?php if($rol[0]==$valor[5]){ echo "selected"; } ?>><?php echo $rol[1] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group mb-2">
                      ...
                      <input type="text" class="form-control" id="inlineFormInputGroup" name="telefono" required placeholder="Digite su telefono..." maxlength="8" value="<?php echo $valor[6] ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group mb-2">
                      ...
                      <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="ciudad" required>
                        <option value="">--Seleccione una ciudad--</option>
                        <?php foreach ($this->obj_cliente->get_ciudad() as $ciudad) { ?>
                          <option value="<?php echo $ciudad[0] ?>"<?php if($ciudad[0]==$valor[7]){ echo "selected"; } ?>><?php echo $ciudad[1] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
